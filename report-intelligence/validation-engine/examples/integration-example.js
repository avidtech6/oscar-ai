...
const ReportValidationEngine_1 = require("../ReportValidationEngine");
const ValidationResultStorage_1 = require("../storage/ValidationResultStorage");
const ValidationEventEmitter_1 = require("../events/ValidationEventEmitter");
...
async function example1BasicValidation() {
    ...
    const validationEngine = new ReportValidationEngine_1.ReportValidationEngine();
    // Add event listeners
 ...
 */
async function example2ValidationWithStorage() {
    console.log('\n=== Example 2: Validation with Storage ===');
    // Create validation engine and storage
    const validationEngine = new ReportValidationEngine_1.ReportValidationEngine();
    const storage = new ValidationResultStorage_1.ValidationResultStorage({
        maxResults: 100,
        autoPrune: true,
        persistToFile: false,
    });
 ...
 */
async function example3CustomRules() {
    console.log('\n=== Example 3: Custom Validation Rules ===');
    const validationEngine = new ReportValidationEngine_1.ReportValidationEngine();
 ...
 */
async function example4EventEmitter() {
    console.log('\n=== Example 4: Event Emitter Integration ===');
    const eventEmitter = new ValidationEventEmitter_1.ValidationEventEmitter();
 ...
 */
async function example5FullIntegrationWorkflow() {
    console.log('\n=== Example 5: Full Integration Workflow ===');
